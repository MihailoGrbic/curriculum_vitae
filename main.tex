...
\newcommand{\mainitem}[3] {
    ...
    \vspace{2pt}    % Space between each entry
}
    	...
    	\begin{cvtable}
    		2018 - \textit{present} & 
    			\mainitem
    				...
    				{Belgrade, Serbia} 
    				{
    				Second-year student at the Electrical and Computer Engineering program (module Signals and Systems). Expected graduation date July 2022. GPA 9.82/10
    				} 
    		\\
    		2014 - 2018 & 
    			\mainitem
    				...
    				{Belgrade, Serbia} 
    				{
                        ...
                        I was part of the honors "mentored" class of top twenty students, who attended special classes taught by prominent university professors. GPA 4.85/5
    				} 
    	\end{cvtable}
    	...
    	\begin{cvtable}
            ...
            2015 - 2017 &
    			\mainitem
    			    ...
    			    {Government of Serbia, Ministry of education} 
    			    {
    				    One 2\textsuperscript{nd} and two 3\textsuperscript{rd} awards at national physics competitions. One 2\textsuperscript{nd} award and two honorable mentions at national programming competitions.
    			    } 
    		\\
     		July 2018 &
     	        \mainitem
    		...
    		2017 &
     	        \mainitem
     	            ...
     	            {College Board} 
     	            {
                        \vspace{-20pt}
    				    \begin{cvitemize} \itemsep0em
    				        \item SAT General test \textbf{1500/1600} (scored higher than or equal to 99\% of students)
    				        \item SAT Subject Test - Mathematics Level 2 \textbf{800/800}
    				        \item SAT Subject Test - Physics \textbf{800/800}
    				    \end{cvitemize}
    				    \vspace{3pt}
    				} 
    	\end{cvtable}
